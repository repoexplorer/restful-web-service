...
import com.sid.rest.webservices.restfulwebservice.model.HelloWorldBean;
...
public class HelloWorldController {
	...
	public String helloWorldInternationalized(
		...
		String msg = messageSource.getMessage("good.morning.message",null,"Default Value", LocaleContextHolder.getLocale() /*locale*/);
		return msg;
		// en = Hello World
		// nl = Goede Morgen
		// fr = Bonjour
